...
const Login = () => {
    ...
    const googleFailure = (error) => {
        console.log(error)
        console.log("Google signin unsucessful");
    }
    ...
    return (
        <Container component="main" maxWidth="xs">
            <Paper className={classes.paper} elevation={3}>
                ...
                <Typography variant="h5">{isSignup ? 'Register' : 'Login in'}</Typography>
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin
                        clientId="103512047200-0p2fbthjm8lgdbbs8sdrrfml1euqv9ck.apps.googleusercontent.com"
                        render={(renderProps) => (
